package com.app.hibernate.persist.converter;

import com.app.hibernate.persist.converter.config.BeanConverterConfig;
import com.app.hibernate.persist.converter.cache.IntrospectionCache;
import com.app.hibernate.persist.converter.page.Pageable;
import com.app.hibernate.persist.converter.type.IEnum;
import com.app.hibernate.persist.exceptions.AppHibernateException;
import com.app.hibernate.persist.converter.utils.ClassUtils;
import com.app.hibernate.persist.converter.utils.NameUtils;
import com.app.hibernate.persist.converter.utils.StrUtils;
    ...
    public static <T> List<T> convert(Class<T> clazz, List<?> list, String[] ignoreProperties) {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                throw new AppHibernateException("列表转换失败", e);
            }
        }
